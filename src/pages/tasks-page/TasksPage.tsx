...
const TasksPage = () => {
  ...
  const handleTasksOrderChange = useCallback(
  ...
  const handleTaskStatusChange = (task: TaskEntity) => {
    ...
    if (task.statusId === undefined) {
      ...
      changeTaskStatus(
        task.id,
        tasksStatuses[taskStatusIdx] ? tasksStatuses[taskStatusIdx].id : -1
      );
    }
    // eslint-disable-next-line
  };
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Manage your tasks"></meta>
        <meta property="og:title" content="Tasks Management"></meta>
      </Helmet>
      <Box className={classes.root}>
        <TasksToolbar
          onAddTaskClick={openTaskFormModal}
          onAddTaskStatusClick={openTaskStatusFormModal}
        />
        ...
        {isTaskFormModalOpen && (
          <TaskFormModal taskToEdit={taskToEdit} onClose={closeTaskFormModal} />
        )}
        ...
        {taskToDelete && (
          <DeleteTaskModal taskToDelete={taskToDelete} onClose={closeDeleteTaskModal} />
        )}
